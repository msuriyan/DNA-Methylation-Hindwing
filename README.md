...
**2. `DEG/` and `DSG/` -- generated by separate upstream pipelines**

- `DEG/`: standard RNA-seq differential expression output (e.g.
  DESeq2/edgeR), one file per comparison with a `log2FC` column and a gene
  ID column.
